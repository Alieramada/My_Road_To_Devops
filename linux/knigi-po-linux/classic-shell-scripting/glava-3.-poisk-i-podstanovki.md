...
awk часто используется для простых однострочных приложений, где необходимо просто напечатать выбранные поля или изменить порядок расположения полей в строке. Поскольку это язык программирования, у вас гораздо больше возможностей, гибкости и контроля даже в небольших программах.
